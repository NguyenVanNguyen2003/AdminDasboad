  ...
  return (
    <div>
      <Helmet>
        ...
        {showForm && (
      <div className="overlay__adcar">
        <h1>Thêm xe</h1>
        <button className='close__adcar' onClick={handleCloseForm}>
          <i><FaX/></i>
        </button>
        <form className='form'>
          ...
          <button className='form__button' type="submit">Thêm xe</button>
        </form>
      </div>
        )}
      <Container>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, imagePath, title, description, price, location, chair, star } = row;
                      ...
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <Avatar alt={title} src={imagePath} />
